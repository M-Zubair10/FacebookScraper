...
import subprocess
import time
from mytools.common.delays import Delay
import logging
import pyautogui
...
class Auto:
    ...
    def __init__(self, user_data_dir=None):
        ...
        self.delay = Delay()
        self.data_dir = user_data_dir or os.path.abspath('tmp')
    ...
    def start_chrome(self, current_url):
        chrome_args = [
            "chrome",
            "--start-maximized",
            "--new-instance",
        ...
        logger.info("Chrome window started!")

    def quit_chrome(self):
        self.chrome_process.terminate()
        logger.info("Chrome window terminated!")
